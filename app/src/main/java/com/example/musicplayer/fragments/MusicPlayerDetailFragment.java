...
public class MusicPlayerDetailFragment extends Fragment {
    ...
    public static MusicPlayerDetailFragment newInstance(UUID soundId,String state) {
        MusicPlayerDetailFragment fragment = new MusicPlayerDetailFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_music_player_detail, container, false);
        findViews(view);
        listeners();
        initView();
        seekBar();
